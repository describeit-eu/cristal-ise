...
public final class EventDO {
  ...
  @java.beans.ConstructorProperties({"id", "actionDesc", "actionDescVersion", "script", "scriptVersion", "stateMachineDesc", "stateMachineVersion", "userLogin", "timestamp", "actionProperties", "itemId", "itemVersion"})
  public EventDO(Long id, UUID actionDesc, String actionDescVersion, UUID script, String scriptVersion, UUID stateMachineDesc, String stateMachineVersion, String userLogin, LocalDateTime timestamp, String actionProperties, UUID itemId, String itemVersion) {
    this.id = id;
  ...
  @java.beans.ConstructorProperties({"actionDesc", "actionDescVersion", "script", "scriptVersion", "stateMachineDesc", "stateMachineVersion", "userLogin", "timestamp", "actionProperties", "itemId", "itemVersion"})
  public EventDO(UUID actionDesc, String actionDescVersion, UUID script, String scriptVersion, UUID stateMachineDesc, String stateMachineVersion, String userLogin, LocalDateTime timestamp, String actionProperties, UUID itemId, String itemVersion) {
    this(null, actionDesc, actionDescVersion, script, scriptVersion, stateMachineDesc, stateMachineVersion, userLogin, timestamp, actionProperties, itemId, itemVersion);
  }

  public EventDO(EventDO other) {
    this(null, other.actionDesc, other.actionDescVersion, other.script, other.scriptVersion, other.stateMachineDesc, other.stateMachineVersion, other.userLogin, other.timestamp, other.actionProperties, other.itemId, other.itemVersion);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(getId(), getActionDesc(), getActionDescVersion(), getScript(), getScriptVersion(), getStateMachineDesc(), getStateMachineVersion(), getUserLogin(), getTimestamp(), getActionProperties(), getItemId(), getItemVersion());
  }

  @Override
  public String toString() {
    return "EventDO[id=%s, actionDesc=%s, actionDescVersion='%s', script=%s, scriptVersion='%s', stateMachineDesc=%s, stateMachineVersion='%s', userLogin='%s', timestamp=%s, actionProperties='%s', itemId=%s, itemVersion='%s']"
      .formatted(this.id, this.actionDesc, this.actionDescVersion, this.script, this.scriptVersion, this.stateMachineDesc, this.stateMachineVersion, this.userLogin, this.timestamp, this.actionProperties, this.itemId, this.itemVersion);
  }
